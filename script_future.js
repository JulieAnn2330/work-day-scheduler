...
function renderText () {   
    var saveEventText8AM = JSON.parse(window.localStorage.getItem("8:00am"));
    $("#8AM").val("");
    $("#8AM").val(saveEventText8AM);

    var saveEventText9AM = JSON.parse(window.localStorage.getItem("9:00am"));
    $("#9AM").val("");
    $("#9AM").val(saveEventText9AM);
    
    var saveEventText10AM = JSON.parse(window.localStorage.getItem("10:00am"));
    $("#10AM").val("");
    $("#10AM").val(saveEventText10AM);
    
    var saveEventText11AM = JSON.parse(window.localStorage.getItem("11:00am"));
    $("#11AM").val("");
    $("#11AM").val(saveEventText11AM);
    
    var saveEventText12PM = JSON.parse(window.localStorage.getItem("12:00pm"));
    $("#12PM").val("");
    $("#12PM").val(saveEventText12PM);
    
    var saveEventText1PM = JSON.parse(window.localStorage.getItem("1:00pm"));
    $("#13PM").val("");
    $("#13PM").val(saveEventText1PM);

    var saveEventText2PM = JSON.parse(window.localStorage.getItem("2:00pm"));
    $("#14PM").val("");
    $("#14PM").val(saveEventText2PM);

    var saveEventText3PM = JSON.parse(window.localStorage.getItem("3:00pm"));
    $("#15PM").val("");
    $("#15PM").val(saveEventText3PM);

    var saveEventText4PM = JSON.parse(window.localStorage.getItem("4:00pm"));
    $("#16PM").val("");
    $("#16PM").val(saveEventText4PM);

    var saveEventText5PM = JSON.parse(window.localStorage.getItem("5:00pm"));
    $("#17PM").val("");
    $("#17PM").val(saveEventText5PM);

    var saveEventText6PM = JSON.parse(window.localStorage.getItem("6:00pm"));
    $("#18PM").val("");
    $("#18PM").val(saveEventText6PM);

    var saveEventText7PM = JSON.parse(window.localStorage.getItem("7:00pm"));
    $("#19PM").val("");
    $("#19PM").val(saveEventText7PM);

    var saveEventText8PM = JSON.parse(window.localStorage.getItem("8:00pm"));
    $("#20PM").val("");
